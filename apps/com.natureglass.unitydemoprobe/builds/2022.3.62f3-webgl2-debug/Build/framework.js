...
var ASM_CONSTS = {
  1198976: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 1199037: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 1199101: function() {return Module.webglContextAttributes.powerPreference;},  
 1199159: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 1199214: function($0) {performance.now = function() { return $0; };},  
 1199262: function($0) {performance.now = function() { return $0; };},  
 1199310: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function __AddJsEventListener(eventNamePtr) {
  ...
  function __DownloadBlob(filename, byteArray, byteLength, mimeType) {
  ...
  function __GetDeviceMemorySize()
      {
  ...
  function __SetCursor(cursorName) {
...
var asmLibraryArg = {
  ...
  "_AddJsEventListener": __AddJsEventListener,
  "_AddTimeTrackingEvent": __AddTimeTrackingEvent,
  "_CopyToClipboard": __CopyToClipboard,
  "_DownloadBlob": __DownloadBlob,
  "_GetDeviceMemorySize": __GetDeviceMemorySize,
  "_GetTotalMemorySize": __GetTotalMemorySize,
  "_GetUserAgent": __GetUserAgent,
  "_HideInfoPanel": __HideInfoPanel,
  "_IsOnline": __IsOnline,
  "_SetCursor": __SetCursor,
